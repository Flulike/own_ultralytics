...
project = "results/ultralytics/m"
date = datetime.now().strftime("%Y%m%d_%H%M")
name = f'{date}_ggmix'

# Train the model
results = model.train(data="ultralytics/cfg/datasets/VisDrone.yaml", epochs=200, imgsz=640, device=device, project=project, batch=12, optimizer='SGD',  name=name, pretrained=True)